...
**Update v1.1:** Fitur keuangan (dana donatur, anggaran, biaya operasional, inventaris) + peta distribusi interaktif

| No | Kode | Nama Dokumen | Versi | Status |
|---:|:---|:---|---:|:---|
| 1 | PRD-01 | Product Requirements Document | 1.1 | ✅ Siap |
| 2 | SRS-01 | Software Requirements Specification | 1.1 | ✅ Siap |
| 3 | SAD-01 | Software Architecture Document | 1.0 | ✅ Siap |
| 4 | DBD-01 | Database Design Document | 1.1 | ✅ Siap |
| 5 | UC-01 | Use Case & User Stories | 1.0 | ✅ Siap |
| 6 | PP-01 | Project Plan & Timeline | 1.0 | ✅ Siap |
| 7 | TP-01 | Test Plan | 1.0 | ✅ Siap |
