...
<div class="card" style="margin-bottom:24px;animation:cardIn .55s .35s both;">
  ...
  <div class="finance-grid">
    ...
    <div class="finance-tile" style="background:linear-gradient(135deg,#e8e8f0,#dadbee);border:1px solid #c7c9e6;"><div style="font-size:13px;color:rgba(0,3,74,.55);">Sisa Dana</div><div style="font-size:20px;font-weight:700;color:#00034a;margin-top:4px;">Rp {{ number_format($sisaDana,0,',','.') }}</div></div>
  </div>
</div>
@else
